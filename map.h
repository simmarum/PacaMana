...
public:
    ...
    int mapa[WYSOKOSC_MAPY][SZEROKOSC_MAPY] = {
        ...
        { mWALL, mCOIN, mWALL, mCOIN, mWALL, mWALL, mWALL, mCOIN, mWALL, mCOIN, mCOIN, mCOIN, mWALL, mCOIN, mCOIN, mCOIN, mWALL, mCOIN, mCOIN, mCOIN, mWALL, mWALL, mWALL}, // 2 - pozycja Pacmana
